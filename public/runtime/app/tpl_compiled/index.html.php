...
?>
						...
						<li class="item_img">
							<?php if ($this->_var['deal_special_item']['company_id'] != '' && $this->_var['deal_special_item']['company_id'] != 0): ?>
								<a href="<?php
echo parse_url_tag("u:finance#company_finance|"."id=".$this->_var['deal_special_item']['id']."".""); 
?>" target="_blank">
							<?php else: ?>
								<a href="<?php
...
?>
					...
					<li class="<?php if ($this->_foreach['deal_recommend']['iteration'] % 2 == 0): ?>last <?php endif; ?><?php if ($this->_foreach['deal_recommend']['iteration'] % 3 == 0 || $this->_foreach['deal_recommend']['iteration'] % 4 == 0): ?>mb0<?php endif; ?>">
						<?php if ($this->_var['deal_recommend_item']['company_id'] != '' && $this->_var['deal_recommend_item']['company_id'] != 0): ?>
							<a href="<?php
echo parse_url_tag("u:finance#company_finance|"."id=".$this->_var['deal_recommend_item']['id']."".""); 
?>" target="_blank">
						<?php else: ?>
							<a href="<?php
...
<div class="index_pro_box">
	<?php if ($this->_var['deal_new_list']): ?>
	<!-- 最新创意 开始 -->
...
?>" target="_blank" class="more_browse f_r">查看更多</a>
	...
	<!-- 最新房产 开始 -->
	<?php if ($this->_var['deal_new_list_2']): ?>
	<div class="blank10"></div>
	<div class="index_m index_new">
		<div class="wrap">
			<h3 class="index_title type_2_title">
			 	<span>|&nbsp;有你，有我，有梦想</span>
		 			<a href="<?php
echo parse_url_tag("u:deals#house|"."type=2".""); 
?>" target="_blank" class="more_browse f_r">查看更多</a>
			 	<div class="blank0"></div>
			</h3>
			<div id="pin_box">
			 	<?php echo $this->fetch('inc/deal_list_index_new_house.html'); ?>
			</div>
		</div>
	 </div>
	<?php endif; ?>
	...
	<!-- 最新公益 开始 -->
	<?php if ($this->_var['deal_new_list_3']): ?>
	<div class="blank10"></div>
	<div class="index_m index_new">
		<div class="wrap">
			<h3 class="index_title type_3_title">
			 	<span>|&nbsp;有你，有我，有梦想</span>
		 		<a href="<?php
echo parse_url_tag("u:deals#selfless|"."type=3".""); 
?>" target="_blank" class="more_browse f_r">查看更多</a>
			 	<div class="blank0"></div>
			</h3>
			<div id="pin_box">
			 	<?php echo $this->fetch('inc/deal_list_index_new_selfless.html'); ?>
			</div>
		</div>
	 </div>
	<?php endif; ?>
	...
	<!-- 最新融资 开始 -->
	<?php if ($this->_var['deal_new_list_4']): ?>
	<div class="blank10"></div>
	<div class="index_m index_new">
		<div class="wrap">
			<h3 class="index_title type_4_title">
			 	<span>|&nbsp;有你，有我，有梦想</span>
		 		<a href="<?php
...
?>" target="_blank" class="more_browse f_r">查看更多</a>
			...
			<div id="pin_box">
			 	<?php echo $this->fetch('inc/deal_list_index_new_finance.html'); ?>
			</div>
		</div>
	 </div>
	<?php endif; ?>
	<?php if ($this->_var['deal_hot_list']): ?>
	<div class="blank10"></div>
	<!-- 热门投资 开始 -->
...
<div class="company_list">
	<div class="container">
		<div class="list_head">
            <span class="name"> 推荐的融资公司 </span>
        </div>
        <div class="list_content clearfix" id="company_scroll">
        	<div class="company_slide_arrow company_hd">
                <a class="glyphicon glyphicon-menu-left company_slide_arrow_left next"></a>
                <a class="glyphicon glyphicon-menu-right company_slide_arrow_right prev"></a>
            </div>
            <div class="company_slide_container company_bd">
            	<ul class="feed_container">
            		<?php $_from = $this->_var['finance_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'finance_item');if (count($_from)):
    foreach ($_from AS $this->_var['finance_item']):
?>
                    <li class="feed">
                        <div class="feed_head clearfix">
                            <div class="feed_head_logo">
                                <a href="<?php
echo parse_url_tag("u:finance#company_show|"."cid=".$this->_var['finance_item']['id']."".""); 
?>" target="_blank">
                                <img width="70" height="70" src="<?php if ($this->_var['finance_item']['company_logo'] == ''): ?><?php echo $this->_var['TMPL']; ?>/images/empty_thumb.gif<?php else: ?><?php echo $this->_var['finance_item']['company_logo']; ?><?php endif; ?>" >
                                </a>
                            </div>
                            <div class="feed_head_name">
                                <a href="<?php
echo parse_url_tag("u:finance#company_show|"."cid=".$this->_var['finance_item']['id']."".""); 
?>" target="_blank"><?php 
$k = array (
  'name' => 'msubstr',
  'v' => $this->_var['finance_item']['company_name'],
  'b' => '0',
  'e' => '10',
);
echo $k['name']($k['v'],$k['b'],$k['e']);
?></a>
                            ...
                            <div class="feed_head_desc">
                                <?php 
$k = array (
  'name' => 'msubstr',
  'v' => $this->_var['finance_item']['company_brief'],
  'b' => '0',
  'e' => '28',
);
echo $k['name']($k['v'],$k['b'],$k['e']);
?>
                        ...
                        <div class="feed_list clearfix">
                            <div class="feed_item item-finance-start">
                                <div class="item_date"><?php 
$k = array (
  'name' => 'to_date',
  'v' => $this->_var['finance_item']['u_create_time'],
  'f' => 'Y-m',
);
echo $k['name']($k['v'],$k['f']);
?></div>
...
$k = array (
  ...
  'uid' => $this->_var['finance_item']['u_id'],
  'type' => 'middle',
);
...
?>" />
                                    ...
                                    <div class="user_event">
                                        <a href="<?php
echo parse_url_tag("u:home#index|"."id=".$this->_var['finance_item']['u_id']."".""); 
?>"><?php echo $this->_var['finance_item']['user_name']; ?></a> 创建了公司
                                    </div>
                                </div>
                            </div>
							<?php if ($this->_var['finance_item']['deal_list']['total_price']): ?>
                            <div class="feed_item">
                                <div class="item_date"><?php 
$k = array (
  'name' => 'to_date',
  'v' => $this->_var['finance_item']['deal_list']['end_time'],
  'f' => 'Y-m',
);
echo $k['name']($k['v'],$k['f']);
?></div>
                                <div class="item_dot"></div>
                                <div class="item_detail">
                                    ¥<?php echo $this->_var['finance_item']['deal_list']['total_price']; ?>万 <?php 
$k = array (
  'name' => 'get_invest_phase',
  'v' => $this->_var['finance_item']['deal_list']['invest_phase'],
);
echo $k['name']($k['v']);
?>
                                </div>
...
<script type="text/javascript">
	jQuery("#company_scroll").slide({titCell:".company_hd ul",mainCell:".company_bd ul",autoPage:true,effect:"left",autoPlay:false,vis:3,trigger:"click",delayTime:700});
</script>
	<?php endif; ?>
<!-- 推荐融资公司  结束 -->
<!-- 看看谁加入了 开始 -->
