...
$strtemp=strtolower(!empty($_REQUEST[CTL])?$_REQUEST[CTL]:"index");	
$module = filter_ma_request($strtemp);
$strtemp=strtolower(!empty($_REQUEST[ACT])?$_REQUEST[ACT]:"index");
$action = filter_ma_request($strtemp);
