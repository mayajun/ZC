	...
	"dealcate"	=>	array(
			...
			"groups"	=>	array(
					...
					"selflesscate"	=>	array(
							...
							"key"	=>	"selflesscate",
							"nodes"	=>	array(
									array("name"=>"互助分类","module"=>"DealSelflessCate","action"=>"index"),
 									array("name"=>"上线互助项目","module"=>"DealSelflessOnline","action"=>"online_index"),
									array("name"=>"未审核互助项目","module"=>"DealSelflessSubmit","action"=>"submit_index"),
 									array("name"=>"互助项目回收站","module"=>"DealSelflessDelete","action"=>"delete_index"),
  							),
					),
					"deal"	=>	array(
							"name"	=>	"投后管理",
